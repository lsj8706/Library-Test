...
class HomeController: UIViewController {
    ...
    private lazy var customViewPager = CustomViewPager(viewControllers: [FirstViewController(), secondVC, FirstViewController()], buttonTitles: ["1", "2", "3"], isScrollEnabled: true)
